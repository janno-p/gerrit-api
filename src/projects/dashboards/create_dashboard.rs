...
pub fn create_dashboard(project_name: String, dashboard_id: String, dashboard_input: DashboardInput) -> CreateDashboardBuilder {
    CreateDashboardBuilder { project_name, dashboard_id, dashboard_input }
}
